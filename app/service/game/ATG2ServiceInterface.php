 ...
 */
class ATG2ServiceInterface extends ATGServiceInterface
{
    /**
    ...
    public function __construct(Player $player = null, GamePlatform $platform = null)
    {
        ...
        if ($platform && $platform->code === 'ATG2') {
            ...
            if (!$this->platform) {
                throw new GameException(trans('atg2_platform_not_configured', [], 'admin_game_platform'));
            }
        }
        ...
        if (!$config) {
            throw new GameException(trans('atg2_platform_config_missing', [], 'admin_game_platform'));
        }
        ...
        if (!empty($missingConfigFields)) {
            ...
            throw new GameException(trans('atg2_platform_config_missing', [], 'admin_game_platform') . ': ' . implode(', ', $missingConfigFields));
        }
